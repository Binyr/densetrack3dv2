...
from densetrack3d.evaluation.core.evaluator2 import Evaluator
...
from densetrack3d.models.evaluation_predictor.evaluation_predictor2 import EvaluationPredictor
...
class RayPredictor:
    ...
    def run_eval(self, split):
        ...
        model = DenseTrack3DV2(
            ...
            use_anyup=True,
            # use_merge_conv=True,
            # merge_dino_method="merge_conv_low_res",
            merge_dino_method="corr",
            merge_dino_corr_method="extra",
            dino_size="[24,32]",
            #
            radius_supp="[3,3,3,7]",
            stride_supp="[1,1,1,1]",
...
def parser_args():
    ...
    parser.add_argument("--use_dino", type=str, default="")
