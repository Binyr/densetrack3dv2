...
accelerate launch  --num_machines 1 --num_processes 2 --mixed_precision 'no' scripts/train/train_acc_3d.py num_steps=40000 \
    ckpt_path=logdirs/densetrack3dv2_ft_lr5e-5_4w_dinov3_anyup_point_semantic \
...
python scripts/eval/eval_3d.py --ckpt logdirs/densetrack3dv2_ft_lr5e-5_4w_dinov3_anyup_point_semantic/model_densetrack3dv2_final.pth \
    --exp_dir logdirs/densetrack3dv2_ft_lr5e-5_4w_dinov3_anyup_point_semantic/results_pstudio_fix \
