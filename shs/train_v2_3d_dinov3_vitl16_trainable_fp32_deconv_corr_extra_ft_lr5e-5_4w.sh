...
accelerate launch  --num_machines 1 --num_processes 2 --mixed_precision 'no' scripts/train/train_acc_3d.py num_steps=40000 \
    ckpt_path=logdirs/densetrack3dv2_dinov3_vitl16_trainable_fp32_deconv_corr_extra_ft_lr5e-5_4w \
    use_dino=dinov3_vitl16  dino_size=32 freeze_dino=False use_deconv=True merge_dino_method=corr merge_dino_corr_method=extra \
