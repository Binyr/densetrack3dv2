...
accelerate launch  --num_machines 1 --num_processes 2 --mixed_precision 'no' scripts/train/train_acc_3d.py num_steps=80000 \
    ckpt_path=logdirs/densetrack3dv2_ft_lr5e-5_8w_dinov3_anyup_corr_feat_ku_dr \
    ...
    merge_dino_method=corr_track_feat merge_dino_corr_method="extra" traj_per_sample=128 freeze_dino=True \
