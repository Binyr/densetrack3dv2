...
accelerate launch  --num_machines 1 --num_processes 2 --mixed_precision 'no' scripts/train/train_acc_3d.py num_steps=40000 \
    ckpt_path=logdirs/cycle_loss/densetrack3dv2_ft_lr5e-5_dinov3_anyup_ku_pstudio_traj64_2 \
    ...
    use_pstudio=True dataset_repeats="[1,20]" \

python scripts/eval/eval_3d.py --ckpt logdirs/cycle_loss/densetrack3dv2_ft_lr5e-5_dinov3_anyup_ku_pstudio_traj64/model_densetrack3dv2_final.pth \
    --exp_dir logdirs/cycle_loss/densetrack3dv2_ft_lr5e-5_dinov3_anyup_ku_pstudio_traj64/results \
